...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>Loomancraft, 1st floor,HP Petrol Pump, Harmu, Ranchi</small>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5 logo">

            <img class="img-fluid" src="img/logo-size.png" alt="">
        </a>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid px-3" src="img/about.jpg" style="object-fit: cover;"
                            alt="">
                    </div>
                </div>
            ...
            <div class="row g-4 portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="rounded overflow-hidden">
                        ...
                        <div class="border border-5 border-light border-top-0 p-4">
                            <p class="text-primary fw-medium mb-2">Handicraft</p>
                            <h5 class="lh-base mb-0">Metal Craft / Paintings / Cards /Scrolls/ Gift Kit /Apparel
                                Accessories / Cane & Bamboo / Stone Craft/ Wood Craft</a>
                        </div>
                    </div>
                </div>
